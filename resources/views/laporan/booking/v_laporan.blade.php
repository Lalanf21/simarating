        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-end mx-3" >
                    <input type="date" name="tanggal" id="tanggal" class="form-control form-control-sm me-3" style="max-width: 180px;">
                    ...
                    <a href="#" type="button" id="buttonExcel" class="btn ms-2 btn-sm btn-outline-primary">
...
{{-- form export excel --}}
<form id="form_export_excel" action="{{ route('export_excel_booking') }}" method="POST" style="display: block;">
    @method('post')
    @csrf
    ...
    <input type="hidden" name="hide_tanggal" id="hide_tanggal">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#buttonExcel').click(function(){
            ...
            $('#form_export_excel [name = "hide_tanggal"]').val(tanggal);
    ...
    function show_data(dt,page){
        ...
        if(dt.length > 0){
            ...
            tbl += '    <td>'+date_id(y.booking_date)+'</td>';
            tbl += '</tr>';
            ...
            tbl += '<tr align="center">';
            tbl += '    <td colspan="5">Data tidak ditemukan</td>';
            tbl += '</tr>';
